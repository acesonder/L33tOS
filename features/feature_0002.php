//START - FEATURES/FEATURE_0002.PHP
<?php
$pageTitle = 'BIOS-style boot screen - L33tOS';
        ...
        <div class="card card-3d mb-4">
            <div class="card-header bg-primary text-white">
                <h2 class="mb-0">
                    ...
                    Feature #0002: BIOS-style boot screen
                </h2>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-primary">#0002</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                                <td><strong>BIOS-style boot screen</strong></td>
                            </tr>
                            <tr>
                                <th>Category:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>BIOS-style boot screen</strong> in the Core System category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <h3>BIOS-style boot screen</h3>
                                <p class="text-muted">Feature demo placeholder</p>
                                <button class="btn btn-primary" onclick="alert('Feature #0002 - BIOS-style boot screen\n\nThis is a stub. Functionality not yet implemented.')">
