//START - FEATURES/FEATURE_0103.PHP
<?php
$pageTitle = 'Restore system - L33tOS';
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-info">#0103</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                                <td><strong>Restore system</strong></td>
                            </tr>
                            <tr>
                                <th>Category:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Restore system</strong> in the Marketplace Hosting category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-info" onclick="alert('Feature #0103 - Restore system\n\nThis is a stub. Functionality not yet implemented.')">
