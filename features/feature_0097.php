//START - FEATURES/FEATURE_0097.PHP
<?php
$pageTitle = 'DNS configuration - L33tOS';
        ...
        <div class="card card-3d mb-4">
            <div class="card-header bg-info text-white">
                <h2 class="mb-0">
                    ...
                    Feature #0097: DNS configuration
                </h2>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-info">#0097</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>DNS configuration</strong> in the Marketplace Hosting category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-info" onclick="alert('Feature #0097 - DNS configuration\n\nThis is a stub. Functionality not yet implemented.')">
