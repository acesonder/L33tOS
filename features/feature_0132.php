//START - FEATURES/FEATURE_0132.PHP
<?php
$pageTitle = 'Form builder - L33tOS';
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-warning">#0132</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Form builder</strong> in the Make+Trap Website Builder category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-warning" onclick="alert('Feature #0132 - Form builder\n\nThis is a stub. Functionality not yet implemented.')">
