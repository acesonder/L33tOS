//START - FEATURES/FEATURE_0129.PHP
<?php
$pageTitle = 'Layout designer - L33tOS';
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-warning">#0129</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                                <td><strong>Layout designer</strong></td>
                            </tr>
                            <tr>
                                <th>Category:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Layout designer</strong> in the Make+Trap Website Builder category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-warning" onclick="alert('Feature #0129 - Layout designer\n\nThis is a stub. Functionality not yet implemented.')">
