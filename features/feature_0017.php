//START - FEATURES/FEATURE_0017.PHP
<?php
$pageTitle = 'Boot log viewer - L33tOS';
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-primary">#0017</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                                <td><strong>Boot log viewer</strong></td>
                            </tr>
                            <tr>
                                <th>Category:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Boot log viewer</strong> in the Core System category.</p>
