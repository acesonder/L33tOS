//START - FEATURES/FEATURE_0139.PHP
<?php
$pageTitle = 'Post editor - L33tOS';
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-warning">#0139</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                                <td><strong>Post editor</strong></td>
                            </tr>
                            <tr>
                                <th>Category:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Post editor</strong> in the Make+Trap Website Builder category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-warning" onclick="alert('Feature #0139 - Post editor\n\nThis is a stub. Functionality not yet implemented.')">
