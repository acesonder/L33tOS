//START - FEATURES/FEATURE_0123.PHP
<?php
$pageTitle = 'URL redirects - L33tOS';
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-info">#0123</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                                <td><strong>URL redirects</strong></td>
                            </tr>
                            <tr>
                                <th>Category:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>URL redirects</strong> in the Marketplace Hosting category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-info" onclick="alert('Feature #0123 - URL redirects\n\nThis is a stub. Functionality not yet implemented.')">
