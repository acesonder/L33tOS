//START - FEATURES/FEATURE_0143.PHP
<?php
$pageTitle = 'Image optimization - L33tOS';
        ...
        <div class="card card-3d mb-4">
            <div class="card-header bg-warning text-white">
                <h2 class="mb-0">
                    ...
                    Feature #0143: Image optimization
                </h2>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-warning">#0143</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Image optimization</strong> in the Make+Trap Website Builder category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-warning" onclick="alert('Feature #0143 - Image optimization\n\nThis is a stub. Functionality not yet implemented.')">
