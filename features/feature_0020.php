//START - FEATURES/FEATURE_0020.PHP
<?php
$pageTitle = 'Export/import config - L33tOS';
        ...
        <div class="card card-3d mb-4">
            <div class="card-header bg-primary text-white">
                <h2 class="mb-0">
                    ...
                    Feature #0020: Export/import config
                </h2>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-primary">#0020</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                                <td><strong>Export/import config</strong></td>
                            </tr>
                            <tr>
                                <th>Category:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Export/import config</strong> in the Core System category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-primary" onclick="alert('Feature #0020 - Export/import config\n\nThis is a stub. Functionality not yet implemented.')">
