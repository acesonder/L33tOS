//START - FEATURES/FEATURE_0077.PHP
<?php
$pageTitle = 'Server directory - L33tOS';
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-info">#0077</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Server directory</strong> in the Marketplace Hosting category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-info" onclick="alert('Feature #0077 - Server directory\n\nThis is a stub. Functionality not yet implemented.')">
