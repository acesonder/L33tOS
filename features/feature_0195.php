//START - FEATURES/FEATURE_0195.PHP
<?php
$pageTitle = 'Password generator - L33tOS';
        ...
        <div class="card card-3d mb-4">
            <div class="card-header bg-light text-white">
                <h2 class="mb-0">
                    ...
                    Feature #0195: Password generator
                </h2>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-light">#0195</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Password generator</strong> in the crapTrap category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-light" onclick="alert('Feature #0195 - Password generator\n\nThis is a stub. Functionality not yet implemented.')">
