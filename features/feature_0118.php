//START - FEATURES/FEATURE_0118.PHP
<?php
$pageTitle = 'User permissions - L33tOS';
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-info">#0118</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>User permissions</strong> in the Marketplace Hosting category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-info" onclick="alert('Feature #0118 - User permissions\n\nThis is a stub. Functionality not yet implemented.')">
