//START - FEATURES/FEATURE_0144.PHP
<?php
$pageTitle = 'Video embedding - L33tOS';
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-warning">#0144</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                                <td><strong>Video embedding</strong></td>
                            </tr>
                            <tr>
                                <th>Category:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Video embedding</strong> in the Make+Trap Website Builder category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-warning" onclick="alert('Feature #0144 - Video embedding\n\nThis is a stub. Functionality not yet implemented.')">
