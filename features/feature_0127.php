...
<div class="row mb-4">
    <div class="col-12">
        <div class="card card-3d bg-gradient-secondary text-white">
            <div class="card-body">
                <h1 class="display-5 fw-bold">
                    <i class="fas fa-envelope me-3"></i>Feature 0127
                </h1>
                <p class="lead mb-0">
                    <i class="fas fa-tag me-2"></i>Category: mailTrap
                </p>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-8">
        <div class="card card-3d">
            ...
            <div class="card-body">
                <h3>Feature 0127 - mailTrap</h3>
                <p class="text-muted">This is a placeholder stub for feature #0127.</p>
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Category:</strong> mailTrap<br>
