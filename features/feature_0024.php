//START - FEATURES/FEATURE_0024.PHP
<?php
$pageTitle = 'Calendar widget - L33tOS';
                    ...
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-primary">#0024</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                                <td><strong>Calendar widget</strong></td>
                            </tr>
                            <tr>
                                <th>Category:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Calendar widget</strong> in the Core System category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-primary" onclick="alert('Feature #0024 - Calendar widget\n\nThis is a stub. Functionality not yet implemented.')">
