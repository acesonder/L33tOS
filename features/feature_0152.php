        ...
        <div class="card card-3d bg-gradient-primary text-white">
            <div class="card-body">
                <h1 class="display-5 fw-bold">
                    <i class="fas fa-piggy-bank me-3"></i>Feature 0152
                </h1>
                <p class="lead mb-0">
                    <i class="fas fa-tag me-2"></i>Category: BankTrap
                </p>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-8">
        <div class="card card-3d">
            ...
            <div class="card-body">
                <h3>Feature 0152 - BankTrap</h3>
                <p class="text-muted">This is a placeholder stub for feature #0152.</p>
                ...
                <div class="alert alert-info">
                    ...
                    <strong>Category:</strong> BankTrap<br>
