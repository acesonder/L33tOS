        ...
        <div class="card card-3d bg-gradient-success text-white">
            <div class="card-body">
                <h1 class="display-5 fw-bold">
                    <i class="fas fa-globe me-3"></i>Feature 0047
                </h1>
                <p class="lead mb-0">
...
<div class="row">
    <div class="col-md-8">
        <div class="card card-3d">
            ...
            <div class="card-body">
                <h3>Feature 0047 - webTrap Browser</h3>
                <p class="text-muted">This is a placeholder stub for feature #0047.</p>
