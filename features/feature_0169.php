//START - FEATURES/FEATURE_0169.PHP
<?php
$pageTitle = 'Attachment support - L33tOS';
        ...
        <div class="card card-3d mb-4">
            <div class="card-header bg-secondary text-white">
                <h2 class="mb-0">
                    ...
                    Feature #0169: Attachment support
                </h2>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><span class="badge bg-secondary">#0169</span></td>
                            </tr>
                            <tr>
                                <th>Title:</th>
                        ...
                        <div class="alert alert-info mt-3">
                            ...
                            <p>This is a feature stub for <strong>Attachment support</strong> in the mailTrap category.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="feature-demo">
                            <div class="text-center p-5">
                                ...
                                <button class="btn btn-secondary" onclick="alert('Feature #0169 - Attachment support\n\nThis is a stub. Functionality not yet implemented.')">
